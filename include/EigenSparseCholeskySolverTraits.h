...
#ifndef __EigenSparseCholeskySolverTraits_h
#define __EigenSparseCholeskySolverTraits_h

#define EIGEN_SPARSEMATRIXBASE_PLUGIN "EigenSparseMatrixBaseAddons.h"
...
class EigenSparseCholeskySolverTraits
{
public:
  typedef T                                             ValueType;
  ...
  //typedef Eigen::CholmodSupernodalLLT< MatrixType > SolverType;
