...
#include "EigenSparseCholeskySolverTraits.h"
...
int main( int argc, char* argv[] )
{
  ...
  typedef EigenSparseCholeskySolverTraits< TCoord > EigenSolverTraits;
  ...
  if( atoi( argv[4] ) == 0 )
    ...
    {
    return ParameterizationQuadEdgeMeshFilterTest< EigenSolverTraits >( argc, argv );
    }
  else
    {
    return EXIT_FAILURE;
